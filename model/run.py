...
displasia_dataset_path = '../../datasets/dataset_displasia_RPperc_bin/treino_e_validacao'
displasia_classes = ['healthy', 'severe'] # 0=healthy, 1=severe
displasia_test_dir = '../../datasets/dataset_displasia_RPperc_bin/teste'
...
OUTPUT_DIR = "Resultados_RPperc_bin"
...
for seed in SEEDS:
    results[seed] = {}
    results[seed]['mobnet_orig'] = carregar_modelo('mobilenet', num_classes,os.path.join(OUTPUT_DIR, "models", str(seed), "mobilenet_originais.pth" ))
    results[seed]['mobnet_recplot'] = carregar_modelo('mobilenet', num_classes,os.path.join(OUTPUT_DIR, "models", str(seed), "mobilenet_RP_perc.pth"))
    results[seed]['effnet_orig'] = carregar_modelo('efficientnet_b0', num_classes,os.path.join(OUTPUT_DIR, "models", str(seed), "efficientnet_b0_originais.pth"))
    results[seed]['effnet_recplot'] = carregar_modelo('efficientnet_b0', num_classes,os.path.join(OUTPUT_DIR, "models", str(seed), "efficientnet_b0_RP_perc.pth"))
