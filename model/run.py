...
OUTPUT_DIR = "resultados_displasia/saida7"  

####### Testando com o dataset de displasia #######
classes = displasia_classes
dataset_path = displasia_dataset_path
TEST_DIR = displasia_test_dir

test_dataset = EnsembleTestDataset(
    TEST_DIR, classes, transform_original=transform_originais, transform_recplot=transform_recplot
    )
