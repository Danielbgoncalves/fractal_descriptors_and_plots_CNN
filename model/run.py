...
displasia_dataset_path = '../../datasets/dataset_displasia_RP_perc/treino_e_validacao'
displasia_classes = ['healthy', 'severe'] # 0=healthy, 1=severe
displasia_test_dir = '../../datasets/dataset_displasia_RP_perc/teste'
